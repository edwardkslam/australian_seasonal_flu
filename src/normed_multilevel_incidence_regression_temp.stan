...
parameters{
  ...
  vector[n_subtypes] effect_temp_errors;
  ...
  real mean_effect_temp;
  real<lower=0> sd_effect_temp;
...
transformed parameters{
  ...
  effect_temp = mean_effect_temp +
    effect_temp_errors * sd_effect_temp;  
...
model {
  ...
  mean_effect_temp ~ student_t(nu, 0, 2.5);
  sd_effect_temp ~ normal(0, sd_sd_effect_sizes);
