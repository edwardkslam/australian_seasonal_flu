...
if(Sys.info()['sysname']=="Windows"){
  ...
  write.csv(earliest_geog_results,
            paste(base_dir,"earliest_geog_results.csv",sep=""),row.names = FALSE)
  write.csv(poor_geog_results,
            paste(base_dir,"poor_geog_results.csv",sep=""),row.names = FALSE)
  write.csv(just_geog_results,
            paste(base_dir,"just_geog_results.csv",sep=""),row.names = FALSE)
  
  write.csv(largest_geog_results_pooled,
            paste(base_dir,"largest_geog_results_pooled.csv",sep=""),row.names = FALSE)
  write.csv(earliest_geog_results_pooled,
            paste(base_dir,"earliest_geog_results_pooled.csv",sep=""),row.names = FALSE)
  write.csv(poor_geog_results_pooled,
            paste(base_dir,"poor_geog_results_pooled.csv",sep=""),row.names = FALSE)
  write.csv(just_geog_geog_results_pooled,
            paste(base_dir,"just_geog_geog_results_pooled.csv",sep=""),row.names = FALSE)
